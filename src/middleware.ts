...
posthog.init('${POSTHOG_KEY}',{api_host:'https://us.i.posthog.com',person_profiles:'identified_only',capture_pageview:true,capture_pageleave:true,autocapture:true,cross_subdomain_cookie:true,opt_out_capturing_by_default:true,session_recording:{maskAllInputs:true},loaded:function(ph){try{var c=JSON.parse(localStorage.getItem('cookieConsent')||'null');if(c&&c.analytics){ph.opt_in_capturing();}}catch(e){}}});
</script>
<!-- End PostHog -->`;
