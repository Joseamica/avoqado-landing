...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        {/* Spin Container */}
        <div className="relative w-14 h-14 active:scale-95 transition-transform duration-200">
          {/* Spinning wrapper */}
          <div className="relative w-full h-full transition-transform duration-700 ease-in-out group-hover:rotate-[360deg]">

            {/* WhatsApp Icon - visible by default, fades out on hover */}
            <div className="absolute inset-0 w-full h-full rounded-full bg-[#25D366] flex items-center justify-center shadow-lg transition-opacity duration-300 group-hover:opacity-0">
            ...
            {/* Avoqado Isotipo - hidden by default, fades in on hover */}
        ...
        {/* Tooltip */}
        <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 hidden md:block opacity-0 group-hover:opacity-100 transition-opacity duration-200 delay-300 bg-black text-white text-sm font-medium px-4 py-2 rounded-full shadow-lg whitespace-nowrap">
          Chatea con Avoqado
        </span>
      </a>
    </div>
