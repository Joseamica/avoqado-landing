 ...
 * contract (screensRef / onTpvClick / children) so it drops into AvoqadoTour
 * unchanged. The screens render at their native 330px design width; a single
 * scale transform on `.pax-photo` sizes the whole unit for display — the
...
export default function PaxPhotoFrame({ screensRef, onTpvClick, children }: Props) {
  return (
