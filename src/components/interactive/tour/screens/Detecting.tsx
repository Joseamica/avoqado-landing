/**
 * 5. DetectingCard — "Acerca o inserta la tarjeta", fiel al real
 * (PaymentScreen.kt): conserva el AvoqadoTopBar "Pago con Tarjeta" y el
 * orden es icono contactless monocromo ARRIBA → monto → instrucción.
 * La tarjeta del cliente entrando es el toque extra del demo (aprobado).
 */
    ...
    <section className="tpv-screen screen-detecting" data-screen="detecting">
      ...
      <div className="detect-body">
        <svg className="detect-icon" width="104" height="84" viewBox="0 0 104 84" fill="none" aria-hidden="true">
          ...
          <path className="wave" d="M78 32a16 16 0 0 1 0 20" stroke="#FAFAFA" strokeWidth="2.4" strokeLinecap="round" />
          <path className="wave w2" d="M86 25a26 26 0 0 1 0 34" stroke="#FAFAFA" strokeWidth="2.4" strokeLinecap="round" />
        </svg>
